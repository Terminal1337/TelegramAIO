...
desc = """
Gradiant tool By commit git#5190 < sexy man he is >
...
come cop light from OakDark#0778 :)
"""
...
def gradiant(startrgb,endrgb,text):
    ...
    for letter in text:
       ...
       # if letter in exchars:
        ...
        banner += f'\x1b[38;2;{r};{g};{b}m{letter}'
...
def Main():
    ...
    with open(args.filename, encoding='utf-8', mode='r', errors='replace') as f:
        for line in f.readlines():
            banner = gradiant(startcolor,endcolor,line)
            with open("lol.txt", encoding='utf-8', mode='a', errors='replace') as f2:
                f2.write(f'{banner}\n')
            print('')
    print(clear)
